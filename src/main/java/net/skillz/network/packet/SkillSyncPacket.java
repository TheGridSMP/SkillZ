...
public record SkillSyncPacket(Collection<Skill> skills, Collection<SkillBonus> skillBonuses) implements FabricPacket {
    ...
    public static SkillSyncPacket fromBuf(PacketByteBuf buf) {
        ...
        return new SkillSyncPacket(skills, bonuses);
    }
